...
echo "alias navi='docker start navi && docker attach navi'" >>/home/vagrant/.bashrc
echo "alias xmcli301='docker start xmcli301 && docker attach xmcli301'" >>/home/vagrant/.bashrc
